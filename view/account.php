...
<body>
			...
			<ul class = "nav navbar-nav pull-right ">
				<li class = "dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="../controller/logout.php"><i class = "glyphicon glyphicon-off"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
	...
	<div class = "container-fluid">	
		<ul class = "nav nav-pills">
			...
			<li class = "active"><a href = "../view/account.php">Accounts</a></li>
			<li><a href = "../view/reserve.php">Reservation</a></li>
			<li><a href = "../view/room.php">Room</a></li>			
		</ul>	
	</div>
	<br />
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<a class = "btn btn-success" href = "../view/add_account.php"><i class = "glyphicon glyphicon-plus"></i> Create New Account</a>
				<br />
				<br />
