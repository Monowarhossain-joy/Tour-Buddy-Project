	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<img style = "float:right;" src = "../assets/about.jpg" width = "250px" height = "250px" />
				<br style = "clear:both;" />
				<br />
				<br />
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "../assets/1.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "../assets/2.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
					<center><h4 style = "color:rgba(0, 255, 0, 1);">Extra Bed</h4></center>
					<center><label style = "color:red;">Php. 800.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "../assets/3.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "../assets/4.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "../assets/5.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "../assets/6.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
