			...
			<ul class = "nav navbar-nav pull-right ">
				<li class = "dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="../controller/logouth.php"><i class = "glyphicon glyphicon-off"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
				...
				<table id = "table" class = "table table-bordered">
					...
					?>	
						<tr>
							...
							<td><center><img src = "../assets/<?php echo $fetch['photo']?>" height = "50" width = "50"/></center></td>
